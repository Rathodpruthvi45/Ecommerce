    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', django_resized.forms.ResizedImageField(blank=True, crop=['top', 'left'], default='/placeholder.png', force_format=None, keep_meta=True, null=True, quality=99, scale=None, size=[400, 200], upload_to='')),
